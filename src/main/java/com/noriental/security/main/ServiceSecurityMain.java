package com.noriental.security.main;
...
public class ServiceSecurityMain {
    ...
    public static void main(String[] args) {
        try { 
            ...
            System.out.println(new SimpleDateFormat("[yyyy-MM-dd HH:mm:ss]").format(new Date()) + " Dubbo service_security service server started!");
